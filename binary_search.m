function [first, last] = date_extents(start, stop, varargin)
% [first, last] = date_extents(start, stop, dates1, dates2, ...)
% start, stop - Find first and last index of dates between these 
%    two Matlab serial dates (datenum/datetime).  
